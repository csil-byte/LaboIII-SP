...
const eventListenersCheckboxes = () => {
    ...
    checkboxes.forEach((checkbox) => {
        ...
        checkbox.addEventListener('click', (ev) => {
            ...
            const tableHeader = Array.from(dataTable.getElementsByTagName('th')) // obtengo los headers
...
export const crearTabla = (data) => {
    ...
    tabla.className += "table table-expand-lg table-bordered table-striped table-light table-hover";
